...
public static class AchievementDefinitions
{
    ...
    private static List<AchievementDefinition> BuildRawList() => new()
    {
        ...
        new() { Id = "music-first-track",      Key = "music_first_track",      Title = "First Track",          Description = "Play your first music track.",                Icon = "music_note",     Category = "Music", Rarity = "Common",    Media = MediaType.Music, Metric = AchievementMetric.MusicPlaysTotal,    TargetValue = 1 },
        new() { Id = "music-mixtape",          Key = "music_mixtape",          Title = "Mixtape",              Description = "Play 50 music tracks.",                       Icon = "queue_music",    Category = "Music", Rarity = "Common",    Media = MediaType.Music, Metric = AchievementMetric.MusicPlaysTotal,    TargetValue = 50 },
        new() { Id = "music-playlist-pro",     Key = "music_playlist_pro",     Title = "Playlist Pro",         Description = "Play 250 music tracks.",                      Icon = "playlist_play",  Category = "Music", Rarity = "Uncommon",  Media = MediaType.Music, Metric = AchievementMetric.MusicPlaysTotal,    TargetValue = 250 },
        new() { Id = "music-vinyl-veteran",    Key = "music_vinyl_veteran",    Title = "Vinyl Veteran",        Description = "Play 1000 music tracks.",                     Icon = "album",          Category = "Music", Rarity = "Rare",      Media = MediaType.Music, Metric = AchievementMetric.MusicPlaysTotal,    TargetValue = 1000 },
        new() { Id = "music-encyclopedia",     Key = "music_encyclopedia",     Title = "Music Encyclopedia",   Description = "Play 5000 music tracks.",                     Icon = "library_music",  Category = "Music", Rarity = "Epic",      Media = MediaType.Music, Metric = AchievementMetric.MusicPlaysTotal,    TargetValue = 5000 },

        new() { Id = "music-hour-fan",         Key = "music_hour_fan",         Title = "Hour Fan",             Description = "Listen to 1 hour of music.",                  Icon = "headphones",     Category = "Music", Rarity = "Common",    Media = MediaType.Music, Metric = AchievementMetric.MusicListeningHours, TargetValue = 1 },
        new() { Id = "music-deep-listener",    Key = "music_deep_listener",    Title = "Deep Listener",        Description = "Listen to 10 hours of music.",                Icon = "graphic_eq",     Category = "Music", Rarity = "Uncommon",  Media = MediaType.Music, Metric = AchievementMetric.MusicListeningHours, TargetValue = 10 },
        new() { Id = "music-marathoner",       Key = "music_marathoner",       Title = "Music Marathoner",     Description = "Listen to 100 hours of music.",               Icon = "speaker_group",  Category = "Music", Rarity = "Rare",      Media = MediaType.Music, Metric = AchievementMetric.MusicListeningHours, TargetValue = 100 },

        new() { Id = "music-album-curious",    Key = "music_album_curious",    Title = "Album Curious",        Description = "Hear tracks from 5 different albums.",        Icon = "album",          Category = "Music", Rarity = "Common",    Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicAlbums,  TargetValue = 5 },
        new() { Id = "music-album-explorer",   Key = "music_album_explorer",   Title = "Album Explorer",       Description = "Hear tracks from 25 different albums.",       Icon = "album",          Category = "Music", Rarity = "Uncommon",  Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicAlbums,  TargetValue = 25 },
        new() { Id = "music-album-collector",  Key = "music_album_collector",  Title = "Album Collector",      Description = "Hear tracks from 100 different albums.",      Icon = "library_music",  Category = "Music", Rarity = "Rare",      Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicAlbums,  TargetValue = 100 },

        new() { Id = "music-artist-curious",   Key = "music_artist_curious",   Title = "Artist Curious",       Description = "Listen to 5 different artists.",              Icon = "mic",            Category = "Music", Rarity = "Common",    Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicArtists, TargetValue = 5 },
        new() { Id = "music-artist-explorer",  Key = "music_artist_explorer",  Title = "Artist Explorer",      Description = "Listen to 25 different artists.",             Icon = "groups",         Category = "Music", Rarity = "Uncommon",  Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicArtists, TargetValue = 25 },
        new() { Id = "music-artist-archive",   Key = "music_artist_archive",   Title = "Artist Archive",       Description = "Listen to 100 different artists.",            Icon = "diversity_3",    Category = "Music", Rarity = "Rare",      Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicArtists, TargetValue = 100 },

        new() { Id = "music-genre-flexible",   Key = "music_genre_flexible",   Title = "Genre Flexible",       Description = "Listen to 5 different music genres.",         Icon = "tune",           Category = "Music", Rarity = "Common",    Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicGenres,  TargetValue = 5 },
        new() { Id = "music-genre-wide-net",   Key = "music_genre_wide_net",   Title = "Wide Net",             Description = "Listen to 10 different music genres.",        Icon = "blur_on",        Category = "Music", Rarity = "Uncommon",  Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicGenres,  TargetValue = 10 },

        new() { Id = "music-time-traveller",   Key = "music_time_traveller",   Title = "Music Time Traveller", Description = "Listen to music from 3 different decades.",   Icon = "history_toggle_off", Category = "Music", Rarity = "Uncommon", Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicDecades, TargetValue = 3 },
        new() { Id = "music-decade-spanner",   Key = "music_decade_spanner",   Title = "Decade Spanner",       Description = "Listen to music from 6 different decades.",   Icon = "stairs",         Category = "Music", Rarity = "Rare",      Media = MediaType.Music, Metric = AchievementMetric.UniqueMusicDecades, TargetValue = 6 },

        // ─── v2.1.0 "Open Library" — Book badges (M3) ──────────────────
        new() { Id = "book-first-page",        Key = "book_first_page",        Title = "First Page",           Description = "Finish your first book.",                     Icon = "menu_book",      Category = "Books", Rarity = "Common",    Media = MediaType.Book,  Metric = AchievementMetric.BooksCompleted,            TargetValue = 1 },
        new() { Id = "book-shelf-starter",     Key = "book_shelf_starter",     Title = "Shelf Starter",        Description = "Finish 5 books.",                             Icon = "book",           Category = "Books", Rarity = "Common",    Media = MediaType.Book,  Metric = AchievementMetric.BooksCompleted,            TargetValue = 5 },
        new() { Id = "book-bibliophile",       Key = "book_bibliophile",       Title = "Bibliophile",          Description = "Finish 25 books.",                            Icon = "auto_stories",   Category = "Books", Rarity = "Uncommon",  Media = MediaType.Book,  Metric = AchievementMetric.BooksCompleted,            TargetValue = 25 },
        new() { Id = "book-librarian",         Key = "book_librarian",         Title = "Librarian",            Description = "Finish 100 books.",                           Icon = "local_library",  Category = "Books", Rarity = "Rare",      Media = MediaType.Book,  Metric = AchievementMetric.BooksCompleted,            TargetValue = 100 },

        new() { Id = "book-audio-listener",    Key = "book_audio_listener",    Title = "Audio Listener",       Description = "Listen to 1 hour of audiobooks.",             Icon = "podcasts",       Category = "Books", Rarity = "Common",    Media = MediaType.Book,  Metric = AchievementMetric.AudiobookListeningHours,   TargetValue = 1 },
        new() { Id = "book-audio-companion",   Key = "book_audio_companion",   Title = "Audio Companion",      Description = "Listen to 25 hours of audiobooks.",           Icon = "podcasts",       Category = "Books", Rarity = "Uncommon",  Media = MediaType.Book,  Metric = AchievementMetric.AudiobookListeningHours,   TargetValue = 25 },
